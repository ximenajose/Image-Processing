...
5. System currently requires toggling between scripts and could benefit from integration, though not recommended at this time to prevent scope creep.


Next steps include: integrating registration into scripts via sci-kit and/or OpenCV. Pending exploration.
